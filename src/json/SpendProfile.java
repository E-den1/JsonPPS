...
public class SpendProfile {
	...
	String Operador = "SPEND_PROFILE_ASSIGN_ACCOUNT";
	String ReferenceBu, RequestId, PolicyId;
	...
	public void Principal() {
	 ...
	 public String LeerTxt (int index) { 
		...
		s1 = "";
		try {
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\account_sp.txt"
					+ ""))) {
				String bfread;
				int counter = 1;
	...
	public void leer() {
		...
		System.out.print("\n");
		System.out.print("Ingresa PolicyId:...");
		PolicyId = teclado.next();
	}
   ...
   public String CuerpoF() {
    ...
    public void GuardarArchivo () {
    	...
    	try {
             String ruta = "\\C:\\\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\SpendProfile.txt";
	...
	public static void main(String[] args) {
		SpendProfile ObjPrincipal;
		ObjPrincipal = new SpendProfile();
