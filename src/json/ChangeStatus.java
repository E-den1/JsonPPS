...
public class ChangeStatus {
	...
	String Operador = "CARD_CHANGE_STATUS";
	...
	public void Principal() {
	 ...
	 public String LeerTxt (int index) { 
		...
		s1 = "";
		try {
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\cardschngsts3.txt"))) {
				String bfread;
				int counter = 1;
	...
	public void leer() {
		...
		System.out.print("\n");
		System.out.print("¿Cual es el estatus?...");
		Status = teclado.next();
	}
	...
	public String  Elementos() {
		...
		for (i=1; i<=RegistrosTotales; i++) {
			if (i<=9) {
				...
				textoJSON.append("   \"CardNumber\":" + LeerTxt(i));
				textoJSON.append("\r\n");
   ...
   public String CuerpoF() {
    ...
    public void GuardarArchivo () {
    	...
    	try {
             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\ChangeStatus.txt";
	...
	public static void main(String[] args) {
		ChangeStatus ObjPrincipal;
		ObjPrincipal = new ChangeStatus();
