...
public class MerchantLoopStore {
	
	Scanner teclado = new Scanner(System.in);
	String ClientIdentifier = "UNBE01BULK";
	String Operador = "CREATE_MERCHANT_LOOP_STORE_GROUP";
	String ReferenceBu, Id,  Loop, External, DateFrom, DateTo ;
	...
	public void Principal() {
		...
		public void leer() {
			...
			System.out.print("\n");
			System.out.print("Valida desde (AAAA-MM-DD):");
			DateFrom = teclado.next();
			System.out.print("\n");
			System.out.print("Valida hasta (AAAA-MM-DD):");
			DateTo = teclado.next();
			...
			for (i=1; i<=RegistrosTotales; i++) {
				if (i<=9) {
					...
					textoJSON.append("         \"Name\": \"PRUEBAPPS\",\r\n"
							+ "         \"Behaviour\": \"ACCEPT\",\r\n");
					textoJSON.append("         \"ValidFrom\": \"" );
				    textoJSON.append(DateFrom);
				    textoJSON.append("\",\r\n");
					textoJSON.append("         \"ValidTo\": \"" );
				    textoJSON.append(DateTo);
				    textoJSON.append("\",\r\n");
				    textoJSON.append("         \"Contact\": {\r\n"
							+ "          \"Name\": \"PRUEBAS\",\r\n"
							+ "          \"PhoneNumber\": \"5555555555\",\r\n"
							+ "           \"Address\": {\r\n"
							+ "            \"BusinessName\": \"EL PESCADITO\",\r\n"
							+ "            \"Street\": \"QUETZAL 100\",\r\n"
							+ "            \"AdditionalLine1\": \"FÉLIX GALLARDO\",\r\n"
							+ "            \"Postal Code\": \"09360\",\r\n"
							+ "            \"City\": \"CDMX\",\r\n"
							+ "            \"State\": \"CDMX\",\r\n"
							+ "            \"Country Code\": \"MX\"\r\n"
				 ...
				 public String CuerpoF() {
				    ...
				    public void GuardarArchivo () {
				    	...
				    	try {
				             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\MerchantLoopStore.txt";
					...
					public static void main(String[] args) {
						MerchantLoopStore ObjPrincipal;
						ObjPrincipal = new MerchantLoopStore();
