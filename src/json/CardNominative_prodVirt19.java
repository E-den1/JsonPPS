...
public class CardNominative_prodVirt19 {

	Scanner teclado = new Scanner(System.in);
	String ClientIdentifier = "UNBE01BULK";
	String Operador = "CARD_NOMINATIVE";
		...
		for (i=1; i<=RegistrosTotales; i++) {
		 ...
		 public String CuerpoF() {
		    ...
		    public void GuardarArchivo () {
		    	...
		    	try {
		             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\CardNominative.txt";
		   ...
		   public String RenovationExpirationDate (int fecharenov) {
			...
			public static void main(String[] args) {
				CardNominative_prodVirt19 ObjPrincipal;
				ObjPrincipal = new CardNominative_prodVirt19();
