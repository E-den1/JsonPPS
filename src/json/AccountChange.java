...
public class AccountChange {
	...
	String Operador = "ACCOUNT_CHANGE_STATUS";
	String ReferenceBu, Status;
	...
	public void Principal() {
	 ...
	 public String LeerTxt (int index) { 
		...
		s1 = "";
		try {                                                            
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\account.txt"))) {
				String bfread;
				int counter = 1;
   ...
   public String CuerpoF() {
    ...
    public void GuardarArchivo () {
    	...
    	try {
             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\AccountChange.txt";
	...
	public static void main(String[] args) {
		AccountChange ObjPrincipal;
		ObjPrincipal = new AccountChange();
