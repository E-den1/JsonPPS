...
public class ReplaceNominativeCardprod19 {

	Scanner teclado = new Scanner(System.in);
	String ClientIdentifier = "UNBE01BULK";
	String Operador = "CARD_REPLACE_NOMINATIVE";
	String ReferenceBu, RequestId, Profile, Status, Groupid;
	...
	public String LeertxtAccount (int index) { 
		...
		s1 = "";
		try {
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\accountreplace.txt"))) {
				String bfread;
				int counter = 1;
	...
	public String LeertxtCard (int index) { 
		...
		s1 = "";
		try {
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\cardreplace.txt"))) {
				String bfread;
				int counter = 1;
				while ((bfread = bf.readLine()) != null) {
					if (counter == index) {
	...
	public void leer() {
		...
		System.out.print("\n");
		System.out.print("¿Cuántos registros se requieren en el Bulk?...");
		RegistrosTotales = teclado.nextInt();
		System.out.print("\n");
		System.out.print("¿Cuál es el estatus de la tarjeta a reemplazar?...");
		Status = teclado.next();
		 ...
		 public String CuerpoF() {
		  ...
		  public String ExpirationDate (int fecha) {
		    ...
		    public void GuardarArchivo () {
		    	...
		    	try {
		             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\\\Edenred\\PRUEBAS\\PPS\\rutas\\ReplaceNominativeCard.txt";
			...
			public static void main(String[] args) {
				ReplaceNominativeCardprod19 ObjPrincipal;
				ObjPrincipal = new ReplaceNominativeCardprod19();
