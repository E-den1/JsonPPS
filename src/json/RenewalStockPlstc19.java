...
public class RenewalStockPlstc19 {

		Scanner teclado = new Scanner(System.in);
		String ClientIdentifier = "UNBE01BULK";
		String Operador = "CARD_RENEWAL_NO_NOMINATIVE_TO_NOMINATIVE";
		...
		public String LeertxtAccount (int index) { 
			...
			s1 = "";
			try {
				try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\accountrenewalstock.txt"))) {
					String bfread;
					int counter = 1;
		...
		public String LeertxtCard (int index) { 
			...
			s1 = "";
			try {
				try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\cardrenewalstock.txt"))) {
					String bfread;
					int counter = 1;
					while ((bfread = bf.readLine()) != null) {
						if (counter == index) {
			 ...
			 public String CuerpoF() {
			  ...
			  public String ExpirationDate (int fecha) {
			    ...
			    public void GuardarArchivo () {
			    	...
			    	try {
			             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\RenewalStock.txt";
				...
				public static void main(String[] args) {
					RenewalStockPlstc19 ObjPrincipal;
					ObjPrincipal = new RenewalStockPlstc19();
