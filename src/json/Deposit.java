...
public class Deposit {
	...
	public void Principal() {
	 ...
	 public String LeerTxt (int index) { 
		...
		s1 = "";
		try {
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\accountdeposit.txt"))) {
				String bfread;
				int counter = 1;
    ...
    public void GuardarArchivo () {
    	...
    	try {
             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\Deposit.txt";
	...
	public static void main(String[] args) {
		Deposit ObjPrincipal;
		ObjPrincipal = new Deposit();
