...
public class WithDrawal {
	...
	public void Principal() {
	 ...
	 public String LeerTxt (int index) { 
		...
		s1 = "";
		try {
			try (BufferedReader bf = new BufferedReader(new FileReader ("\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\accountwithdrawal.txt"))) {
				String bfread;
				int counter = 1;
	...
	public void leer() {
		...
		System.out.print("\n");
		System.out.print("¿Cual es el monto a retirar?...");
    ...
    public void GuardarArchivo () {
    	...
    	try {
             String ruta = "\\C:\\Users\\amarroquin\\OneDrive - EDENRED\\Documents\\Edenred\\PRUEBAS\\PPS\\rutas\\WithDrawal.txt";
	...
	public static void main(String[] args) {
		WithDrawal ObjPrincipal;
		ObjPrincipal = new WithDrawal();
